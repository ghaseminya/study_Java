...
그래서, 현재 코드에서 발생하는 이 부분을 해결하기 위해 제네릭이 도입되었습니다.(컴파일시 예외가 발행하지 않고 런타임시 에러발생)
제네릭으로 수행하게 되면 컴파일단계에서 타입 체크를 할 수 있게 되어 타입이 맞이 않은 경우 컴파일 단계에서 확인할 수 있습니다.
