...
따라서 정상적이지 못한 실행의 결과가 나올 수도 있습니다.
...
class Sum {
	...
	//둘 이상의 쓰레드가 메모리 공간에 동시 접근할 경우 문제가 발생하는 코드
...
class ThreadEx10 {
	public static void main(String[] args) {
		...
		//스레드에 join()호출한 경우와 호출하지 않은 경우 결과 확인하기
		//TODO: 스레드에 join()호출하지 않은 경우 결과 확인하기
		//TODO: 스레드에 join()호출한 경우 결과 확인하기
