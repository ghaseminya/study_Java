...
public class AnonymousEx02 {
	...
	public void innerTest(){
		...
		//익명 내부 클래스 (구현부) - 
		//익명 내부 클래스는 정의부를 따로 정의하지 않고 구현부만 존재하며 구현부안의 정의부에 있던 내용이 포함되어 집니다.
		//이름이 없는 내부 클래스의 객체 생성시 부모클래스의 이름을 쓰거나 인터페이스명을 사용합니다. 
		//익명 내부 클래스는 반드시 객체생성을 바로 해주어야 합니다.
		//class Inner해서 클래스이름을 지정했던 것을 이름 없이 
		//상속받은 클래스명인 InnerParent2를 사용하여 객체 생성을 합니다.
